...
index fde12bee44f6c4cdd420705aa8ab36e30360fa10..2282a6d396b52fecab0fd9214faab3a8e17f130d 100644
--- a/streamlit_app.py
+++ b/streamlit_app.py
@@ -1,6 +1,211 @@
...
+st.caption("Audio-only mode enabled: agent input is voice-only and AI client replies are spoken automatically.")
+
